...
function ProfileCard({ profile }: { profile: UserProfile }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div>
        <p className="text-xs text-gray-400 uppercase tracking-wide">Notification ID</p>
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center p-6">
      {/* Phone frame */}
      <div className="w-[375px] bg-white rounded-[44px] shadow-2xl overflow-hidden border-[10px] border-slate-800">
        {/* Notch */}
        ...
        <div className="overflow-y-auto max-h-[580px] px-5 py-5 space-y-4">
          ...
          {/* Token section — auto-generated, read-only with refresh */}
          <div>
