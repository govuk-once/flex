...
const DYNAMIC_ROUTE_LIST: { pattern: RegExp; contract: RouteContract }[] = [
  ...
  },
  {
    ...
    contract: ROUTE_CONTRACTS["GET:/v1/vehicle-enquiry"],
  },
  {
    pattern: /^POST:\/v1\/share-code\/[^/]+\/cancel$/,
    contract: ROUTE_CONTRACTS["POST:/v1/share-code/:id/cancel"],
  },
  {
    pattern: /^POST:\/v1\/unlink-user\/[^/]+$/,
    contract: ROUTE_CONTRACTS["POST:/v1/unlink-user/:id"],
  },
  {
    pattern: /^GET:\/v1\/customer\/vehicle\/[^/]+$/,
    contract: ROUTE_CONTRACTS["GET:/v1/customer/vehicle/:id"],
  },
];
